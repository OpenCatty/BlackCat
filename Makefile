...
LDFLAGS     := -X github.com/OpenCatty/BlackCat/internal/version.Version=$(VERSION) \
               -X github.com/OpenCatty/BlackCat/internal/version.Commit=$(COMMIT) \
               -X github.com/OpenCatty/BlackCat/internal/version.BuildDate=$(BUILD_DATE)

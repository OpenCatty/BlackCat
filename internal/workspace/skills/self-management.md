...
- Go install: `go install github.com/startower-observability/blackcat@latest`
...
- "How to update?" → Tell them: re-run the install script or `go install github.com/startower-observability/blackcat@latest`

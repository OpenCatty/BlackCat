---
title: LLM Providers
description: Setup guide for all 8 supported LLM providers including OpenAI, Anthropic, Gemini, and GitHub Copilot
---
...
See [OAuth Setup](/oauth#github-copilot--device-code-flow) for detailed authentication guide.
...
See [OAuth Setup](/oauth#tos-risk-acknowledgment) for details.
...
See [Zen Coding Plan](/zen-plan) for details.
...
- [OAuth Setup](/oauth) — OAuth flow details
- [Zen Coding Plan](/zen-plan) — Zen-specific guide

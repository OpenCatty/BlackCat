---
title: Zen Coding Plan
description: Curated hosted models via the Zen plan — setup, available models, and billing
---
...
- [Configuration Reference](/configuration) — Zen config fields
- [Getting Started](/getting-started) — Quick start with Zen

...
If you need reliable Google model access, use the official [Gemini provider](/providers#google-gemini-official) with an API key instead.
...
- [LLM Providers](/providers) — All provider details
- [Configuration Reference](/configuration) — OAuth config fields
- [CLI Configure](/configure-cli) — Interactive auth setup

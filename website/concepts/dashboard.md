...
1. Start the daemon: `blackcat start`
...
Real-time updates are pushed to the dashboard via Server-Sent Events (SSE) at `/dashboard/events`. This endpoint is used for live UI updates and does not require authentication in the current version.

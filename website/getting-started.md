...
description: Prerequisites, installation, and quick start guide for BlackCat
---
...
See [CLI Configure](/configure-cli) for the full command reference.
...
- [Configuration Reference](/configuration) — Full YAML config guide
- [LLM Providers](/providers) — All supported providers
- [OAuth Setup](/oauth) — GitHub Copilot and Antigravity auth
- [Zen Coding Plan](/zen-plan) — Hosted model access
- [CLI Configure](/configure-cli) — Interactive setup wizard
- [Architecture](/architecture) — How BlackCat works

...
- [Configuration Reference](./configuration.md) — Full config guide
- [LLM Providers](./providers.md) — Provider details
- [OAuth Setup](./oauth.md) — Copilot and Antigravity OAuth walkthrough
- [Zen Coding Plan](./zen-plan.md) — Curated hosted models
